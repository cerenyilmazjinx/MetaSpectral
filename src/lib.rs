...
#[derive(Debug)]
pub struct MetaSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaSpectral processing");
    
    let mut processor = MetaSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaSpectralProcessor::new(false);
